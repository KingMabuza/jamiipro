"""
Django settings for jamiipro project.
...
SECRET_KEY = 'django-insecure-#w+=y^1s&%$b_m9ptebc=uejdttv75$qq1oix7!ftxv((+c_#b'
...
WSGI_APPLICATION = 'jamiipro.wsgi.application'
